...
public class DeveloperAdapter extends RecyclerView.Adapter<DeveloperAdapter.ViewHolder> {
    ...
    /**
     * Edit this to see Changes in Developer Tab.
     * Change data.setThumbnail value to change the image
     */
    ...
    public DeveloperAdapter() {
        ...
        data.setThumbnail(R.drawable.bravo_inc);
        data.setName("Bravo Inc");
        data.setDetail("Founder/Lead Developer/Themer of BravoUX \n \nBravoUX contains Modified SystemUI, Ported Themes and more!");
        mItems.add(data);
